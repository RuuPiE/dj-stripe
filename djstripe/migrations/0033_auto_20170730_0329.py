...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djstripe', '0032_auto_20170730_0252'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='charge',
            name='source_type',
            field=djstripe.fields.StripeCharField(choices=[(b'sepa_debit', 'Sepa Debit'), (b'bitcoin_receiver', 'Bitcoin receiver'), (b'card', 'Card'), (b'alipay_account', 'Alipay account'), (b'bank_account', 'Bank account')], help_text=b'The payment source type. If the payment source is supported by dj-stripe, a corresponding model is attached to this Charge via a foreign key matching this field.', max_length=20, null=True),
        ),
        migrations.AlterField(
            model_name='charge',
            name='status',
        ...
        migrations.AlterField(
            model_name='sepasource',
            name='currency',
            field=djstripe.fields.StripeCurrencyField(decimal_places=2, max_digits=8),
        ),
        migrations.AlterField(
            model_name='sepasource',
            name='last4',
        ...
        migrations.AlterField(
            model_name='sepasource',
            name='mandate_url',
            field=djstripe.fields.StripeURLField(),
        ),
        migrations.AlterField(
            model_name='sepasource',
            name='status',
            field=djstripe.fields.StripeCharField(choices=[(b'pending', b'pending'), (b'chargeable', b'chargeable'), (b'consumed', b'consumed'), (b'canceled', b'canceled'), (b'failed', b'failed')], max_length=255),
        ),
        migrations.AlterField(
            model_name='sepasource',
            name='usage',
        ...
        migrations.AlterField(
            model_name='transfer',
            name='source_type',
            field=djstripe.fields.StripeCharField(choices=[(b'sepa_debit', 'Sepa Debit'), (b'bitcoin_receiver', 'Bitcoin receiver'), (b'card', 'Card'), (b'alipay_account', 'Alipay account'), (b'bank_account', 'Bank account')], help_text=b'The source balance from which this transfer came.', max_length=16),
        ),
        migrations.AlterField(
            model_name='transfer',
            name='status',
